...
public class ItensCompra {
    ...
    private int nrNotaFiscalCompra;
    ...
    /**
     * @return the nrNotaFiscalCompra
     */
    public int getNrNotaFiscalCompra() {
        return nrNotaFiscalCompra;
    }

    /**
     * @param nrNotaFiscalCompra the nrNotaFiscalCompra to set
     */
    public void setNrNotaFiscalCompra(int nrNotaFiscalCompra) {
        this.nrNotaFiscalCompra = nrNotaFiscalCompra;
    }
